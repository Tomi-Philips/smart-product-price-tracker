      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-orange-100 text-orange-700 px-6 py-2 rounded-full text-sm font-medium mb-6">
            Designed and Developed with ❤️ by AfopTech
          </div>
      ...
      <footer className="bg-white border-t border-gray-200 py-12 px-4 mt-auto">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-500 text-sm mb-4">
            &copy; {new Date().getFullYear()} DealDrop. All rights reserved.
          </p>
          <div className="flex justify-center gap-6 text-sm text-gray-400">
            <p>Designed and Developed by <span className="text-orange-600 font-medium">AfopTech</span></p>
          </div>
        </div>
      </footer>
    </main>
